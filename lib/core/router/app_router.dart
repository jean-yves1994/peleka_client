...
final routerProvider = Provider<GoRouter>((ref) {
  return GoRouter(
    ...
    routes: [
      ...
      GoRoute(path: '/shipments/:id', builder: (_, s) => ShipmentDetailScreen(id: s.pathParameters['id']!)),
      GoRoute(path: '/shipments/:id/track', builder: (_, s) => TrackingScreen(id: s.pathParameters['id']!)),
    ],
  );
});
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              const Text('We could not open that screen', style: TextStyle(fontSize: 18, fontWeight: FontWeight.w700, color: Color(0xFF08295D))),
              const SizedBox(height: 8),
              Text(location, textAlign: TextAlign.center, style: const TextStyle(fontSize: 12, color: Color(0xFF64748B))),
