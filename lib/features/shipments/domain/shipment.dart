class Shipment {
  ...
  final double customerOutstandingBalance;
  ...
  factory Shipment.fromJson(Map<String, dynamic> j) {
    ...
    return Shipment(
        ...
        status: j['status'] ?? 'awaiting_assignment',
        ...
        deliveryLat: d(j['delivery_lat']),
        deliveryLng: d(j['delivery_lng']),
        parcelDescription: j['parcel_description'] ?? '',
        parcelCategory: j['parcel_category'],
        parcelWeightKg: d(j['parcel_weight_kg']),
        isFragile: j['is_fragile'] == true,
        distanceKm: d(j['distance_km']),
        totalPrice: d(j['total_price']),
        discountAmount:
            j['discount_amount'] == null ? null : d(j['discount_amount']),
        taxAmount: d(j['tax_amount']),
        riderEarnings:
            j['rider_earnings'] == null ? null : d(j['rider_earnings']),
        ...
        customerOutstandingBalance: d(j['customer_outstanding_balance']),
        createdAt: t(j['created_at']) ?? DateTime.now(),
        pickedUpAt: t(j['picked_up_at']),
        deliveredAt: t(j['delivered_at']));
  }
}
...
class Quote {
  ...
  const Quote(
      ...
      required this.currency,
      this.discountCode,
      this.breakdownNote, this.paymentRequired = true});
  factory Quote.fromJson(Map<String, dynamic> j) {
    ...
    return Quote(
        distanceKm: d(j['distance_km']),
        durationMinutes: d(j['duration_minutes']),
        baseFare: d(j['base_fare']),
        distanceFee: d(j['distance_fee']),
        weightFee: d(j['weight_fee']),
        ...
        breakdownNote: j['breakdown_note'],
        paymentRequired: j['payment_required'] != false);
  }
}
...
class ShipmentTimelineEntry {
  ...
  final String? note;
  final DateTime createdAt;
  const ShipmentTimelineEntry(
      {required this.toStatus, this.note, required this.createdAt});
  factory ShipmentTimelineEntry.fromJson(Map<String, dynamic> j) =>
...
class ShipmentDetail {
  ...
  final List<ShipmentTimelineEntry> statusHistory;
  ...
  factory ShipmentDetail.fromJson(Map<String, dynamic> j) => ShipmentDetail(
      shipment: Shipment.fromJson(j['shipment']),
      statusHistory: (j['status_history'] as List? ?? [])
          .map((e) => ShipmentTimelineEntry.fromJson(e))
          .toList(),
      proofs: (j['proofs'] as List? ?? [])
          .map((e) => Map<String, dynamic>.from(e))
          .toList(),
      rating:
          j['rating'] == null ? null : Map<String, dynamic>.from(j['rating']),
